		...
		meta.settings.get('sso-github', function(err, settings) {
			...
			if (!err && settings.id && settings.secret) {
				passport.use(new GithubStrategy({
					...
					scope: 'openid,profile,address,roles,offline_access,multichannelmanagement' // fetches non-public emails as well
				...
				strategies.push({
					...
					scope: 'openid,profile,address,roles,offline_access,multichannelmanagement'.split(',')
				});
			}
