...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'http://10.69.1.101/identitydemo/connect/authorize';
  options.tokenURL = options.tokenURL || 'http://10.69.1.101/identitydemo/connect/token';
  ...
  this.name = 'github';
  this._userProfileURL = options.userProfileURL || 'http://10.69.1.101/identitydemo/connect/userinfo';
