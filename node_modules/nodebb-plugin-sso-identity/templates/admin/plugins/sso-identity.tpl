<div class="row">
	<div class="col-sm-2 col-xs-12 settings-header">IdentityServer SSO</div>
	<div class="col-sm-10 col-xs-12">
		
		<form class="sso-identity-settings">
			...
			<div class="form-group alert alert-warning">
				...
				<p class="help-block">
					Ensure that this value is set in your IdentityServer application&apos;s settings
				</p>
			</div>
			<div class="checkbox">
