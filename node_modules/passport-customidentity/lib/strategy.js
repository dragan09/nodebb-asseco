 ...
 *
 * The IdentityServer authentication strategy authenticates requests by delegating to
 * IdentityServer using the OAuth 2.0 protocol.
 *
 ...
 *
 * Options:
 *   - `clientID`      your IdentityServer application's Client ID
 *   - `clientSecret`  your IdentityServer application's Client Secret
 *   - `callbackURL`   URL to which IdentityServer will redirect the user after granting authorization
